...
// Minimal manifest for Claude Desktop Extension - try different format
const MANIFEST = {
    dxt_version: '0.0.1',  // Try 0.0.1 instead of 0.1.0
    name: 'OmniFocus GTD',
    ...
    author: {
        ...
        // Remove email field - might not be required
    },
    server: {
        command: 'node',
        args: ['server/index.js']
    }
    // Remove all optional fields to find minimum required set
};
